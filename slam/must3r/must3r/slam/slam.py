...
def main():
    ...
    parser.add_argument('--pointcloud_conf', default=1.0, type=float,
                        help="Confidence threshold for the exported keyframe pointcloud")
    ...
    if args.output is not None:
        ...
        pointcloud_path = os.path.join(args.output, "pointcloud.ply")
        print(f"Writing pointcloud in {pointcloud_path}")
        args.model.write_pointcloud(pointcloud_path, conf_thr=args.pointcloud_conf)
